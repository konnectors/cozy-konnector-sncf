[Cozy][cozy] Voyage-Sncf connector
==================================
...
A connector to retrieve your voyage-sncf bills and billing data and save them into your Cozy.
...
git://github.com/cozy/cozy-konnector-sncf.git#build
...
Voyage-Sncf connector is developed by Chocobozzz and distributed under the [AGPL v3 license][agpl-3.0].
